...
export const FRUITS = [
  { category: "Mangoes", items: [
    {
      ...
      basePrice: 315,
      tiers: [{ minQty: 10, pricePerUnit: 305 }],
  ...
  { category: "Exotics & Everyday", items: [
    {
      name: "Mangosteen",
      tagline: "Deep purple rind, snow-white segments inside — the 'queen of fruits', delicately sweet-tart and juicy",
      unit: "kg", step: 0.5, min: 0.5,
      basePrice: 1200,
      tiers: [{ minQty: 1, pricePerUnit: 1100 }],
...
export const GIFT_BOXES = [
  {
    ...
    contents: "2 Chausa Mango, 2 Banarsi Langda Mango, 1 Dragon Fruit, 4 Mandarin Orange, 2 New Zealand Apple, 2 Bartlett Pear, 2 Golden Kiwi, 2 Anaar, 2 Mangosteen, 1 Box Jumbo Blueberry",
    unit: "box", step: 1, min: 1,
    basePrice: 3490,
    tiers: [],
    images: [
  ...
  },
  {
    ...
    contents: "5 New Zealand Apple, 3 Hass Avocado, 6 Mandarin Orange, 5 Malta, 4 Anaar",
    unit: "box", step: 1, min: 1,
    basePrice: 3490,
    tiers: [],
    images: [
