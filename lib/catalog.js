...
export const FRUITS = [
  ...
  { category: "Seasonal Favourites", items: [
    ...
    },
    {
      ...
      basePrice: 550,
      tiers: [],
      badge: "Best Seller", images: ["/fruits/donutpeach.JPG"], color: "#FB7185",
    },
    {
      name: "Nectarines",
      tagline: "Smooth-skinned and juicy — like a peach, without the fuzz",
      unit: "box", step: 1, min: 1,
      basePrice: 590,
      tiers: [],
      badge: "Best Seller", images: ["/fruits/nectarines.jpg"], color: "#F43F5E",
    },
  ]},
  { category: "Exotics & Everyday", items: [
    {
      ...
      basePrice: 1100,
      tiers: [{ minQty: 1, pricePerUnit: 1050 }],
    ...
    {
      name: "Orange Passion Fruit (Sweet Granadilla)",
      tagline: "Fragrant and floral-sweet, with a crunchy, edible seed pulp (500g box, 6-7 pcs)",
      unit: "box", step: 1, min: 1,
      basePrice: 500,
      tiers: [],
      images: ["/fruits/orangepassionfruit.JPG"], color: "#F97316",
    },
    {
    ...
    },
    {
      ...
      badge: "Best Seller", images: ["/fruits/redglobegrapes.jpg"], color: "#BE123C",
    },
    {
      name: "Muscat Grapes",
    ...
    },
    {
      ...
      badge: "Best Seller", images: ["/fruits/moondrops.jpg"], color: "#7C2D92",
    },
    {
    ...
    },
    {
      ...
      basePrice: 330,
      tiers: [],
      badge: "Best Seller", images: ["/fruits/jumboblueberry.JPG"], color: "#3730A3",
    },
    {
      name: "Longan",
    ...
    },
    {
      ...
      tagline: "Creamy, custard-like flesh with a fragrant, honeyed sweetness",
      unit: "kg", step: 0.5, min: 1,
      basePrice: 450,
      tiers: [],
      images: ["/fruits/sharifa.jpg"], color: "#84A045",
    },
  ]},
...
export const GIFT_BOXES = [
  ...
  // basePrice is null on the boxes below — pricing hasn't been finalised yet.
  // getMinPurchasePrice/formatRate are never called for gift boxes (they're
  // enquiry-only), so this is safe; ProductPage shows "Price on enquiry"
  // instead of "from ₹X" when basePrice is null.
  {
    name: "🍍 The Tropical Harvest Box",
    tagline: "A vivid mix of orchard classics and tropical favourites — pineapple, pomegranate and crisp Rockit apples in one colourful box.",
    contents: "Rockit Apples, Mandarin Orange, Pomegranate, Pineapple, Pear, Black Grapes",
    unit: "box", step: 1, min: 1,
    basePrice: null,
    tiers: [],
    images: ["/gift-boxes/tropical-harvest/1.jpg"],
    color: "#CA8A04",
  },
  {
    name: "🌅 The Sunrise Orchard Box",
    tagline: "Citrus-bright mandarins, crisp apples and jewel-toned pomegranate — a cheerful, everyday gifting box.",
    contents: "Mandarin Orange, New Zealand Queen Apple, Pomegranate, Pear, Black Grapes",
    unit: "box", step: 1, min: 1,
    basePrice: null,
    tiers: [],
    images: ["/gift-boxes/sunrise-orchard/1.jpg"],
    color: "#F97316",
  },
  {
    name: "🍯 The Golden Mango Box",
    tagline: "Netted, hand-ripened imported mangoes paired with pomegranate and citrus — a fragrant, luxurious mango moment.",
    contents: "Imported Mango, Pomegranate, Malta Orange, Red Apple, Green Grapes",
    unit: "box", step: 1, min: 1,
    basePrice: null,
    tiers: [],
    images: ["/gift-boxes/golden-mango/1.jpg"],
    color: "#D97706",
  },
  {
    name: "🫐 The Berry Orchard Box",
    tagline: "Deep purple grapes and plump blueberries alongside crisp apples and citrus — antioxidant-rich and beautifully colour-blocked.",
    contents: "Black Grapes, Blueberry, New Zealand Queen Apple, Malta Orange",
    unit: "box", step: 1, min: 1,
    basePrice: null,
    tiers: [],
    images: ["/gift-boxes/berry-orchard/1.jpg"],
    color: "#3730A3",
  },
  {
    name: "🥝 The Exotic Trio Box",
    tagline: "Imported mango, Zespri Sungold kiwi and creamy avocado — an exotic trio rounded out with orchard favourites.",
    contents: "Imported Mango, Zespri Sungold Kiwi, Avocado, New Zealand Queen Apple, Pear, Malta Orange",
    unit: "box", step: 1, min: 1,
    basePrice: null,
    tiers: [],
    images: ["/gift-boxes/exotic-trio/1.jpg"],
    color: "#EAB308",
  },
  {
    name: "🍐 The Pear & Pomegranate Box",
    tagline: "Juicy pears and ruby pomegranate take centre stage, backed by crisp apples and a cluster of grapes.",
    contents: "Pear, New Zealand Queen Apple, Pomegranate, Grapes",
    unit: "box", step: 1, min: 1,
    basePrice: null,
    tiers: [],
    images: ["/gift-boxes/pear-pomegranate/1.jpg"],
    color: "#84CC16",
  },
  {
    name: "💼 The Prestige Exotic Box",
    tagline: "Our most indulgent box — peaches, mangosteen, Sungold kiwi and imported mango, packed in a designer keepsake case.",
    contents: "Pear, Peach, Mangosteen, Zespri Gold Kiwi, Imported Mango, Blueberry, Red Grapes, New Zealand Queen Apple, Pomegranate",
    unit: "box", step: 1, min: 1,
    basePrice: null,
    tiers: [],
    images: ["/gift-boxes/prestige-exotic/1.jpg"],
    color: "#6D28D9",
  },
];
...
// Curated for the homepage "Bestsellers" section — order is intentional,
// not derived from actual sales data.
