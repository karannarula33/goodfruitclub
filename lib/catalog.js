  ...
  { category: "Mangoes", items: [
    {
      ...
      basePrice: 310,
      tiers: [{ minQty: 10, pricePerUnit: 310 }],
    ...
    },
    {
      ...
      unit: "kg", step: 0.5, min: 1,
      basePrice: 275,
      tiers: [{ minQty: 10, pricePerUnit: 255 }],
...
export const GIFT_BOXES = [
  {
    ...
    contents: "2 Chausa Mango, 2 Banarsi Langda Mango, 1 Dragon Fruit, 4 Mandarin Orange, 2 New Zealand Apple, 2 Pear, 2 Golden Kiwi, 2 Anaar, 2 Mangosteen, 1 Box Jumbo Blueberry",
    unit: "box", step: 1, min: 1,
    basePrice: 3490,
    tiers: [],
    images: [
