...
export const GIFT_BOXES = [
  {
    ...
    contents: "2 Chausa Mango, 2 Banarsi Langda Mango, 1 Dragon Fruit, 4 Mandarin Orange, 2 New Zealand Queen Apple, 2 Bartlett Pear, 2 Golden Kiwi, 2 Anaar, 2 Mangosteen, 1 Box Jumbo Blueberry",
    unit: "box", step: 1, min: 1,
    basePrice: 3490,
    tiers: [],
    images: [
