...
// below searches this list too). "tagline" doubles as the contents subline.
export const GIFT_BOXES = [
  {
    name: "Mango & Exotics",
    tagline: "2 Chausa Mango, 2 Banarsi Langda Mango, 1 Dragon Fruit, 4 Mandarin Orange, 2 New Zealand Apple, 2 Pear, 2 Golden Kiwi, 2 Anaar, 2 Mangosteen, 1 Box Jumbo Blueberry",
    unit: "box", step: 1, min: 1,
    basePrice: 2990,
    tiers: [],
    images: [
